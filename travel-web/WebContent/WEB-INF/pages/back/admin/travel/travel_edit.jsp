	...
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div class="panel-heading">
					<strong><span class="glyphicon glyphicon-pencil"></span>&nbsp;出差申请单(修改)</strong>
				</div>
							...
							<div class="form-group" id="sdateDiv">
								...
								<div class="col-md-5">
									...
									<input type="text" id="sdate" name="sdate" class="form-control"
										value="<fmt:formatDate value="${travel.sdate}" pattern="yyyy-MM-dd"/>" >
								</div>
								<!-- 定义表单错误提示显示元素 -->
							...
							<div class="form-group" id="edateDiv">
								...
								<div class="col-md-5">
									...
									<input type="text" id="edate" name="edate" class="form-control"
										value="<fmt:formatDate value="${travel.edate}" pattern="yyyy-MM-dd"/>">
								</div>
								<!-- 定义表单错误提示显示元素 -->
